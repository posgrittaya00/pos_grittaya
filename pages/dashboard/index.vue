<template>
    <div class="flex flex-wrap">
        ...
        <div class="flex w-full items-center">
            <div
                class="flex gap-2 w-1/4 h-[140px] justify-around items-center bg-white p-4 rounded-lg shadow-lg text-black mr-2 mb-2 mt-2">
                <div class="flex flex-col">
                    <h3 class="text-[1.5rem] text-[#7A7C7F] font-semibold mb-2">ยอดขายทั้งหมด</h3>
                    <p class="text-[1.5rem] font-bold">1,000,000 บาท</p>
                </div>
                <div
                    class="rounded-full shadow-[4px_4px_4px_rgba(0,0,0,0.25)] w-16 h-16 bg-[#3B7EBF] mt-2 flex items-center justify-center">
            ...
            <div
                ...
                <div
                    class="rounded-full shadow-[4px_4px_4px_rgba(0,0,0,0.25)] w-16 h-16 bg-[#FABD4E] mt-2 flex items-center justify-center">
            ...
            <div
                ...
                <div
                    class="rounded-full shadow-[4px_4px_4px_rgba(0,0,0,0.25)] w-16 h-16 bg-[#49BA6C] mt-2 flex items-center justify-center">
            ...
            <div
                ...
                <div
                    class="rounded-full shadow-[4px_4px_4px_rgba(0,0,0,0.25)] w-16 h-16 bg-[#E59D48] mt-2 flex items-center justify-center">
        ...
        <div class="w-3/5 bg-white p-4 rounded-lg shadow-lg text-black mr-2 mb-2" style="height: auto;">
            ...
            <p class="text-2xl font-bold">วันที่ 01/05/2024: รายการใหม่ 10 รายการ</p>
            <p class="text-2xl font-bold">วันที่ 02/05/2024: รายการใหม่ 15 รายการ</p>
