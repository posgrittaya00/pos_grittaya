<template>
    <div class="flex min-h-full flex-col justify-center items-center px-6 py-12 lg:px-8 bg-white w-[500px] rounded-md mt-2 mx-auto">
      <div class="sm:mx-auto sm:w-full sm:max-w-sm">
        <img class="mx-auto h-[200px] w-auto" src="public/img/grit3.png" alt="Your Company">
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="#" method="POST">
          ...
          <div>
            ...
            <div class="text-sm">
              <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">ลืมรหัสผ่าน?</a>
            </div>
          </div>
